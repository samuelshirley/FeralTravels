...
**Start at `docs/design/ios-e2e-bringup.md`** — it records what is proven, what is not, and the traps, and its first line is the one that matters: no Maestro flow has ever passed anywhere yet.
