          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;background:#FFFFFF;border:1px solid #E6DFD4;border-radius:14px;padding:32px;">
            ...
            <tr>
              <td align="center" style="padding-bottom:24px;">
                <a href="${escapedUrl}" style="display:inline-block;background:#4E7AB0;color:#FFFFFF;text-decoration:none;padding:12px 22px;border-radius:8px;font-weight:600;font-size:14px;">
                  Sign in to Feral Travels
                </a>
              </td>
            </tr>
            <tr>
              <td style="font-size:12px;color:#6B6B6B;line-height:1.5;padding-bottom:12px;">
                Or copy and paste this URL:
              </td>
            </tr>
            <tr>
              <td style="font-size:12px;color:#4E7AB0;word-break:break-all;padding-bottom:24px;">
                <a href="${escapedUrl}" style="color:#4E7AB0;text-decoration:underline;">${escapedUrl}</a>
              </td>
            </tr>
            <tr>
