...
**Subscriptions.** Seven days free from sign-up, capped at $1 of Anthropic spend — whichever runs out first. Then one of two auto-renewing products: `com.feraltravels.ios.monthly` at **$2/month** or `com.feraltravels.ios.annual` at **$20/year**, bought through RevenueCat (`mobile/lib/purchases.ts`), which shows the store's localized price.
