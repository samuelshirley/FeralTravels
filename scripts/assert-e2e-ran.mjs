...
if (skipped > 0 && skipped <= MAX_SKIPPED) {
  summary(
    `::warning::${skipped} of ${skipped + ran} E2E tests did not run. This build is green on ${ran} test(s). The skip allowance (E2E_MAX_SKIPPED=${MAX_SKIPPED}) is a temporary concession in .github/workflows/ci.yml — lower it back to 0.`,
  );
}
